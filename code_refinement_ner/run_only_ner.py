...
#    encoder.load_adapter("lang_adapters/java", load_as="java_adapter", with_head=False)
 ...
 #   encoder.add_adapter_fusion(Fuse("java_adapter","java_type_adapter"))
    encoder.set_active_adapters("java_type_adapter")
  #  adapter_setup = Fuse("java_adapter","java_type_adapter")
  #  encoder.train_adapter_fusion(adapter_setup)
    encoder.train_adapter("java_type_adapter")
